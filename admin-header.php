...
<html>
  ...
  <body class="sidebar-mini fixed">
    <div class="wrapper">
      <!-- Navbar-->
      <header class="main-header hidden-print"><a class="logo" href="index.php">B2B</a>
        ...
        <section class="sidebar">
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p>Admin</p>
              <p class="designation">B2B</p>
            </div>
          </div>
          <!-- Sidebar Menu-->
          <ul class="sidebar-menu">
            <li id="home"><a href="index.php"><i class="fa fa-dashboard"></i><span>Dashboard</span></a></li>
            <li id="borrowers" class="treeview"><a href="#"><i class="fa fa-user-circle-o"></i><span>Salesman</span><i class="fa fa-angle-right"></i></a>
              <ul class="treeview-menu">
                <li id="add-borrower"><a href="add-salesman.php"><i class="fa fa-user-plus"></i> Add Salesman</a></li>
                <li id="all-borrowers"><a href="all-salesman.php"><i class="fa fa-list"></i> All Salesman</a></li>                
              </ul>
            </li>
